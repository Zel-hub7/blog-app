...
RSpec.describe Post, type: :model do
  ...
  it 'expects to be valid with valid attribute' do
    post_object = Post.new(title: 'Microverse School', author_id: @author_object.id, comments_counter: 0, likes_counter: 0)
  ...
  it 'Should respond to some methods' do
    post_object = Post.new(title: 'Microverse School', author_id: @author_object.id, text: 'My school', comments_counter: 0, likes_counter: 0)
  ...
  it 'Should show the 5 comments' do
    ...
    post_object = Post.new(title: 'Microverse School', author_id: author_object.id, text: 'Remote School', comments_counter: 0, likes_counter: 0)
    post_object.save

    comment_texts = ['I want to study HTML & CSS', 'I want to study JS', 'I want to study REACT', 'I want to study Ruby', 'I want to study Ruby on Rails']
    comment_objects = comment_texts.map do |text|
      Comment.create(user_id: author_object.id, post_id: post_object.id, text: text)
    end
